"""
Shared test helpers: mock client and parametrization utilities.

Kept in a regular module (not conftest.py) so static type checkers can resolve
imports from it. pytest hooks and fixtures still live in conftest.py.
"""
