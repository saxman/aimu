...
Runs a FastMCP server that registers every function in `aimu.tools.builtin.ALL_TOOLS` (weather, search, calculate, get_web_content, wikipedia, list_directory, read_file, echo, get_current_date_and_time, convert_time).
