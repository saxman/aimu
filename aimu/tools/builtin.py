...
# ---- Windowed reads ----------------------------------------------------------
#
# The window, the marker, and the argument complaints live in ``aimu._window``, shared with
# the document MCP server in ``aimu.memory``. They are aliased to private names here because
# that is what every call site below already reads as, and because they are not part of this
# module's public tool surface.

_window = window
_window_complaint = window_complaint
_past_end = past_end
