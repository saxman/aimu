...
│   │   ├── factory.py       # ProviderEntry + build_client/resolve_model_string/factory_model_kwargs/FactoryDelegate: shared dispatch for the 5 modality factories (image/audio/speech/transcription/embedding); factories take provider kwargs directly (**kwargs), legacy model_kwargs= deprecated
